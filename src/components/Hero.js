...
const Hero = () => {
  ...
  return (
    ...
    <section className="grid grid-cols-3 w-full p-8 bg-slate-400 gap-4">
      <div className="flex flex-col gap-5 col-span-2 text-white">
        ...
        <div className=" w-full">
          <h1 className="font-semibold font-serif text-7xl w-[80%]">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="flex flex-col gap-2 border-2 border-[#366BD9] rounded-lg p-3 hover:bg-slate-500">
            <img src={heroIMG} alt="news" className="h-[84px] w-[114px] rounded-lg" />
